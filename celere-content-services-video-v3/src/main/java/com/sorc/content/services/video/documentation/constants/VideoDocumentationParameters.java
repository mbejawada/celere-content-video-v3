...
public class VideoDocumentationParameters {
	...
	public static final String DOC_PARAM_SHOW_CATEGORY_ID = "Show category id belongs to video i.e. 71654712";
	...
	public static final String SORT_BY = "Optional, possible values are : START_DATE, EPISODE_NUM, VIEWS";
