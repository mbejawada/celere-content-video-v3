 ...
 * 
 */
package com.sorc.content.elasticsearch.core.constant;

/**
 * @author rakesh.moradiya
 *
 */
public class AppleXmlFeedConstants {
	...
	public static final String UMC_CATALOG = "umcCatalog";
	public static final String XMLNS_UMC = "xmlns:umc";
	...
	public static final String LOCALE_VAL = "en-US";
	public static final String SYSTEM_CODE = "systemCode";
	public static final String SYSTEM_CODE_VAL = "us-tv";
	public static final String URL = "url";	
	public static final String ARTWORK_TYPE_COVERAGE_SQUARE = "cover_artwork_square";
	public static final String ARTWORK_TYPE_TITLE = "tile_artwork";
	public static final String ARTWORK_TYPE_TITLE_ = "tile_artwork";
	public static final String TV_SHOWINFO = "tvShowInfo";
	public static final String TV_SHOW_TYPE_VAL = "series";	
	public static final String NETWORK = "network";
	public static final String NETWORK_MOTORTREND = "Motor Trend";	
	
	
	public static final String TV_SEASONINFO = "tvSeasonInfo";	
	public static final String SHOW_CONTENT_ID = "showContentId";
	public static final String SEASON_NUMBER = "seasonNumber";
	public static final String ORIGINAL_PREMIERE_DATE = "originalPremiereDate";
	...
	public static final String TV_EPISODEINFO = "tvEpisodeInfo";
